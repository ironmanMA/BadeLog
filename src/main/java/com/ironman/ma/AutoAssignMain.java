...
public class AutoAssignMain {
    static BadeLog badeLog = BadeLoggerFactory.getLogger(AutoAssignMain.class);
    /*
    ...
    */
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < 10000; i++) {
            ...
            badeLog.error("THIS IS AN WHAT!!!");
            badeLog.debug("THIS IS AN WHAT!!!");
            badeLog.info("THIS IS AN WHAT!!!");
        }
